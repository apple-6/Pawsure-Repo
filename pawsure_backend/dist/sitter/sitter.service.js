...
let SitterService = class SitterService {
    ...
    fileService;
    userRepository;
    constructor(sitterRepository, userService, fileService, userRepository) {
        this.sitterRepository = sitterRepository;
        this.userService = userService;
        this.fileService = fileService;
        this.userRepository = userRepository;
    }
    async create(createSitterDto, userId, file) {
        ...
        let idDocumentUrl;
        if (file) {
            idDocumentUrl = await this.fileService.uploadPublicFile(file.buffer, file.originalname, 'sitter-id-documents');
