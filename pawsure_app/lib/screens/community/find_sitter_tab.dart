...
// NOTE: You will also need to update SitterService.fetchSitters() or add a new SitterService.fetchSittersByRange()
// to accept and use the start and end dates, as implemented in the backend SitterService.ts file.
